...
'        connect(server)
'        If server = "lean" And s_sql_access Or server = "symple" And s_symple_access Then
...
'            Next
'            If server = "symple" And s_symple_access Then
'                connect("symple")
...
'                            sw_sql.Stop()
'                        End If
'                        frm_main.Label27.Text = "SQL OK"
'                    Case "symple"
'                        s_symple_access = True
'                        If sw_symple.IsRunning Then
'                            sw_symple.Stop()
'                        End If
'                        frm_main.Label28.Text = "SYMPLE OK"
'                End Select
...
'                            sw_sql.Start()
'                        End If
'                        frm_main.Label27.Text = ex.ToString
'                    Case "symple"
'                        s_symple_access = False
'                        If Not sw_symple.IsRunning Then
'                            sw_symple.Start()
'                        End If
'                        frm_main.Label28.Text = ex.ToString
'                End Select
'            End Try
'        End If
